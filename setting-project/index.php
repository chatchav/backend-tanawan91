...
<html lang="en">
    ...
    <?php 
     @session_start(); 
        ...
        $result = mysqli_query($con,"SELECT * FROM `setting_website` WHERE page = 'project'");
                    ...
                    <div class="container-fluid px-4">
                        <div class="row col-sm-12 mb-4">
                            <div class="col-sm-10">
                                ...
                                <small style="color:#e26330">Setting / Project</small>
                            </div>
                        </div>
                        <form id="frm-data" enctype="multipart/form-data" method="post">
                            ...
                            <input type="hidden" id="page" name="page" class="form-control" value="project">
                            <div class="card-body">
                                <!-- Tabs content -->
                                <div class="row py-2">
                                    <div class="col-2">
...
<script src="../js/setting-project.js"></script>

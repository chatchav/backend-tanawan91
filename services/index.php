                    ...
                    <div class="container-fluid px-4">
                        <div class="row col-sm-12 mb-4">
                            ...
                            <div class="col-sm-2 div-btn">
                                <button  type="button" id="add-service" class="mt-4 btn btn-primary">Add Services</button>
                            </div>
                        </div>
                                    ...
                                    <table>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $result = mysqli_query($con, "select serviceId, title, description, createDate  from services".$lang." where status = 'A' and type = 'design' order by seq asc ");
                                                $i = 0;
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="/services/edit.php?id=<?php echo $row[0];?>" type="button" class="btn btn-warning btn-edit-data m-1" data-id="<?php echo $row[0];?>" ><i class="fa-regular fa-pen-to-square"></i></a>
                                ...
                                <div class="tab-pane fade show active" id="build">
                                    <table>
                                        ...
                                        <tbody>
                                            <?php
                                                global $con;
                                                $result = mysqli_query($con, "select serviceId, title, description, createDate  from services".$lang." where status = 'A' and type = 'build' order by seq asc");
                                                $i = 0;
                                                $n_rows = mysqli_num_rows($result);
                                                while ($row = mysqli_fetch_row($result)) {
                                                    $disup = "";

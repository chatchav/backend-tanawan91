                    ...
                    <div class="container-fluid px-4">
                        <div class="row col-sm-12 mb-4">
                            <div class="col-sm-10">
                                ...
                                <small style="color:#e26330">Services / Edit</small>
                            </div>
                        </div>
                        <div class="card-body">
                            <form id="frm-data" method="post">   
                                <input type="hidden" id="flagAction" name="flagAction" className="form-control" value="update" />
                                ...
                                <div class="col-sm-12 py-2" style="text-align:end;">
                                    <a href="/services" type="button" class="btn btn-secondary" >Close</a>

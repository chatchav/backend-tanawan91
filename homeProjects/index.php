                        ...
                        <div class="card-body">
                            <table class="datatablesSimple">
                                ...
                                <tbody>
                                    <?php
                                        global $con;
                                        $result = mysqli_query($con, "SELECT h.projectId, a.image, a.title, h.createDate FROM `home_projects` h INNER JOIN projects a ON a.projectId = h.projectId WHERE h.status = 'A' order by h.seq asc");
                                        $i = 0;
